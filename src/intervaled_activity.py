...
class RequestQueue:
    ...
    def get_queue_state(self, queueid, srv_rate):
        ...
        if "1" in queueid:		
            ...
            # print("\n CHECK -> ", srv_rate, " === ", srvrate1, srvrate2, " *** ",self.srvrates_1, self.srvrates_2)         
            ...
            sample_interchange_time = markov_model.compute_expected_time_between_changes(self.arr_rate, self.srvrates_2, N=100)
            #arr_rate1, arr_rate2 = servmarkov_model.arrival_rates_divisor(self.arr_rate, self.srvrates_1, self.srvrates_2) #_steady_state_distribution()
            #steady_state_distribution = servmarkov_model.best_queue_delay(arr_rate1, self.srvrates_1, arr_rate2, self.srvrates_2)
            arr_rate1, arr_rate2 = servmarkov_model.arrival_rates_divisor(self.arr_rate, self.srvrates_1, self.srvrates_2) #_steady_state_distribution()
            steady_state_distribution = servmarkov_model.best_queue_delay(arr_rate1, self.srvrates_1, arr_rate2, self.srvrates_2)            
